...
class LoginController extends BaseController
{
    ...
    private $resetPwBody =    " <html><body> "
                            ...
                            . " If you did not request this, please email president@tceva.us and ask that your account be locked.<br>"
                            . " <br>"
                            . " Your new password is <b>%password%</b> \n"
                            . " <br> "
                            . " Once you have logged on, you can change your password under 'My Profile' to a phrase of your desire."
                            . "<br><br>"
                            . " TCEVA. "
                            . " </body></html>" ;
